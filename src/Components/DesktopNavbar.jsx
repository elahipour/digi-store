        ...
        <nav className="sticky hidden md:block rounded-md md:rounded-none bg-white md:mx-0 top-0 mt-4 md:mt-0 items-end shadow-lg py-5 z-10">
            <div className='container max-w-screen-2xl flex justify-between gap-x-4 mx-auto'>
                <div className="flex order-2 gap-2 items-center relative w-1/3 py-2">
                    ...
                    <input className="w-[100%] ml-4 pr-9 pl-4 border-none rounded-lg focus:outline-none ring ring-1 py-2 ring-orange-200 focus:ring-2 focus:ring-orange-300" type="text" placeholder='جستوجو' />
                </div>
